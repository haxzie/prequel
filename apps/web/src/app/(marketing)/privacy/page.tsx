...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Never collected, on either side: screen contents, keystrokes, window titles, file names, audio, or anything out of a transcript. The zooms are placed by reading your clicks and your typing, and that reading happens on your Mac and stays there.",
